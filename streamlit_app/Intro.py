...
def main():
    ...
    st.markdown(
        ...
        Explore análises de mercado, crédito, benchmarks financeiros e insights sobre o setor bancário brasileiro cobrindo **+4 mil** instituições financeiras reguladas pelo Bacen.
